...
//Another interesting thing in the code is this condition- 
//while (number < PRINT_NUMBERS_UPTO � 1). 
//Why check for one less than the required number? 
//It is because loop will anyway run for all the three threads and for value 8 itself one thread will increment it to 9 and another to 10.
class PrintSequenceRunnable implements Runnable{
	 
	public int PRINT_NUMBERS_UPTO=30;
	static int  number=1;
	int remainder;
